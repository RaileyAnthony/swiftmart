      ...
      <div className="no-scrollbar flex-1 h-[95vh] flex flex-col justify-between">
        ...
        >
          ...
          <div className="flex flex-col gap-1 max-w-md">
            <label className="text-[14px] font-medium" htmlFor="product-name">
              Product Name
            </label>
            <input
          ...
          <div className="w-full flex flex-col gap-1">
            <label className="text-[14px] font-medium" htmlFor="category">
              Category
            </label>
            <select
              ...
              value={category}
              id="category"
              className="border border-gray-300 text-secondary-900/70 rounded w-full p-2 mt-1 outline-primary-500 cursor-pointer"
            >
          ...
          <div className="flex items-center gap-5 flex-wrap">
            ...
            <div className="flex-1 flex flex-col gap-1 w-32">
              <label className="text-[14px] font-medium" htmlFor="offer-price">
                Offer Price
              </label>
              <input
